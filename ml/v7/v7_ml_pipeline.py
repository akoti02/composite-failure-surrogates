"""
================================================================================
RP3 V7 MACHINE LEARNING PIPELINE — COMPOSITE CRACK-DAMAGE SURROGATE MODEL
================================================================================
...
PURPOSE:
    Train ML surrogate models on V7 composite simulation data (1000 samples).
...
IMPROVEMENTS OVER V4:
    1. Double data (1000 vs 500 samples)
    2. CatBoost alongside XGBoost
    3. SHAP explainability analysis
    4. Dimensionless/physics-based feature engineering
    5. Gaussian Process Regression with native uncertainty quantification
    6. Optuna hyperparameter tuning
    7. Multi-output neural network with shared layers
    8. Conformal prediction intervals (MAPIE)
    9. Physics-informed neural network loss
   10. Repeated k-fold cross-validation

EXPECTED CSV: simulation_results_v7.csv (1000 rows, ~60 columns)
    Inputs: n_defects, defect geometry (x5), pressure_x/y, ply_thickness, etc.
    Outputs: max_mises, tsai_wu_index, hashin modes, failure flags

USAGE:
    1. pip install catboost shap optuna mapie
    2. Place simulation_results_v7.csv in DATA_DIR (or update DATA_PATH)
    3. Run: python v7_ml_pipeline.py
    4. Figures saved as fig_v7_*.png at 300 DPI in figures_v7/

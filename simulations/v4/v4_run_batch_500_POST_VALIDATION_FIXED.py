...
# --- Skip pre-checks if they already passed ---
SKIP_CALIBRATION = True   # Set False to re-run calibration
SKIP_VALIDATION  = True   # Set False to re-run validation
...
def main():
    ...
    if SKIP_CALIBRATION:
        print('\nStep 1/3: Pressure calibration SKIPPED (already passed)')
        cal_passed = True
    else:
    ...
    if SKIP_VALIDATION:
        print('\nStep 2/3: Analytical validation SKIPPED (already passed)')
    ...
    if SKIP_CALIBRATION and SKIP_VALIDATION:
        print('\nPre-checks previously passed — proceeding to batch.')
    else:
        print('\n' + '=' * 60)

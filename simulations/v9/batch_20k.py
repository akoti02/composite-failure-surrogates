"""
Production batch runner: 20,750 CalculiX composite plate simulations.
12 parallel workers on 16-core Intel Ultra 9 285H.
Based on batch_3000_parallel.py with: logging to file, periodic CSV backup, resume support.

Usage:
  python batch_20k.py              # full 20k run (resumes from existing CSV)
  python batch_20k.py --test 10    # test run with 10 sims first
"""
...
LOG_FILE = os.path.join(WORK_DIR, "batch_20k.log")
...
def main():
    ...
    # Step 2: Generate ALL crack polygons

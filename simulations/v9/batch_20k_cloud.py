...
CLOUD VERSION — 30 workers on GCP e2-standard-32 (32 vCPUs, 128 GB RAM).
Based on batch_20k.py with paths adapted for Linux.

Usage:
  python3 batch_20k_cloud.py              # full 20k run (resumes from existing CSV)
  python3 batch_20k_cloud.py --test 10    # test run with 10 sims first
"""
